...
# (1) Install Python 3.8, pip, colcon, and necessary ROS packages
...
# ---------------------------
# Installer les dépendances de libcamera et compiler libcamera avec l'option pycamera activée
RUN apt-get update && apt-get install -y --no-install-recommends \
...
# ---------------------------
# Upgrade pip and install Python packages (incluant pycamera2)
RUN pip3 install --upgrade pip && \
    pip3 install dynamixel_sdk opencv-python pycamera2 tf-transformations pyyaml
