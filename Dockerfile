...
#RUN pip install dynamixel_sdk opencv-python picamera2 tf-transformations pyyaml
...
RUN pip3 install --upgrade pip && pip3 install dynamixel_sdk opencv-python pycamera2 tf-transformations pyyaml
