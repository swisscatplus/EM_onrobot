# --- App image on top of the base (libcamera+picamera2 already in /opt/camvenv) ---
...
# Colcon via apt (on l'exécutera avec /opt/camvenv/bin/python)
RUN apt-get update && apt-get install -y --no-install-recommends \
      python3-dev python3-smbus i2c-tools build-essential git \
      python3-colcon-common-extensions \
    && rm -rf /var/lib/apt/lists/*

# Dépendances Python spec appli si besoin (smbus2 par ex.)
